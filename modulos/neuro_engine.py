...
APERTURAS_POR_CANAL = {
    "La Viuda": [
        ...
        "RESULTADO PRIMERO (open loop): empieza por el desenlace perturbador y promete contar cómo se llegó ahí. Ej. de molde: 'Para cuando salió de esa casa, ya no era la misma persona. Esto fue lo que pasó'.",
        "POV INMERSIVO: mete al espectador en la escena en primera persona. Ej. de molde: 'Estás solo en casa. Escuchas tu nombre desde el cuarto de al lado'.",
        "ADVERTENCIA AL ESPECTADOR: avisa que lo que viene puede inquietarlo de verdad, subiendo la tensión. Ej. de molde: 'Si estás solo ahora mismo, quizá quieras esperar a mañana para ver esto'.",
        "DATO REAL ESCALOFRIANTE: arranca con un hecho verificable e inquietante que da credibilidad. Ej. de molde: 'En esta colonia, siete familias reportaron lo mismo la misma noche'.",
        "CUENTA REGRESIVA: anuncia que algo va a pasar y cuándo, creando tensión creciente. Ej. de molde: 'Faltaban cuarenta minutos para que todo cambiara, y nadie lo sabía'.",
    ],
    "Monkygraff": [
        ...
        "ACTOR INESPERADO: un país o grupo que nadie miraba y que cambió el equilibrio de poder.",
        "RECURSO ESTRATÉGICO: un material/energía/ruta por el que se está jugando una guerra silenciosa.",
        "AFIRMACIÓN CONTRARIAN: desafía la creencia común sobre el tema (genera disonancia que obliga a ver). Ej. de molde: 'Todo lo que te contaron sobre este conflicto está al revés'.",
        "RESULTADO PRIMERO (open loop): revela la consecuencia geopolítica y promete explicar cómo se llegó. Ej. de molde: 'El mapa de poder ya cambió. La mayoría aún no se entera. Te explico'.",
        "AUTORIDAD/CREDIBILIDAD: posiciona el análisis como información que pocos entienden. Ej. de molde: 'Lo que vas a entender en estos minutos, muy pocos analistas lo conectan'.",
        "ESCENARIO DE RIESGO: plantea lo que está en juego de forma concreta para el espectador. Ej. de molde: 'Si esto pasa, el precio de todo lo que compras va a cambiar'.",
        "LO QUE NADIE DICE: enmarca el video como la información que otros evitan. Ej. de molde: 'Hay una razón por la que los grandes medios no están conectando estos puntos'.",
    ],
    "FiltradoMX": [
        ...
        "RESULTADO PRIMERO (open loop): empieza por cómo terminó todo y promete contar el origen. Ej. de molde: 'Acabó perdiéndolo todo. Y empezó con un mensaje que no debió abrir'.",
        "POV INMERSIVO: pon al espectador en los zapatos del protagonista. Ej. de molde: 'Imagina descubrir que la persona en quien más confiabas te mentía desde el día uno'.",
        "CONTRARIAN/JUICIO: lanza una afirmación que divide opiniones y pide tomar partido. Ej. de molde: 'Para muchos fue la víctima. Cuando termines, no estarás tan seguro'.",
        "NÚMERO + PROMESA: un dato concreto de la historia que crea curiosidad. Ej. de molde: 'Tres mensajes bastaron para destruir una familia entera'.",
        "DILEMA MORAL: plantea la decisión imposible del protagonista. Ej. de molde: 'Tenía que elegir entre proteger a su hermana o decir la verdad'.",
    ],
    "LaesquinaRandom": [
        ...
        "POV RIDÍCULO: mete al espectador en una situación absurda en primera persona. Ej. de molde: 'POV: eres el último humano que no sabe usar esta cosa'.",
        "CONTRARIAN ABSURDO: defiende con cara seria una idea ridícula. Ej. de molde: 'Voy a demostrarte que los lunes en realidad no existen'.",
        "PROMESA EXAGERADA: promete algo desproporcionado y cómico. Ej. de molde: 'Esto que vas a ver te va a cambiar la vida. O no. Probablemente no'.",
        "FALSA SERIEDAD: arranca como documental serio sobre algo totalmente tonto. Ej. de molde: 'Los científicos llevan años ignorando esta pregunta fundamental'.",
    ],
    "TuIALista": [
        ...
        "RESULTADO PRIMERO (open loop): muestra lo que se logra y promete enseñar cómo. Ej. de molde: 'Este video lo hizo una IA en cinco minutos. Te enseño exactamente cómo'.",
        "CONTRARIAN: desafía una creencia común sobre la IA o la tecnología. Ej. de molde: 'Llevas usando la inteligencia artificial mal todo este tiempo'.",
        "FOMO/URGENCIA: plantea que se están quedando atrás si no saben esto. Ej. de molde: 'Mientras tú lo haces a mano, otros ya lo automatizaron'.",
        "NÚMERO + CURIOSITY GAP: combina cifra concreta con información incompleta. Ej. de molde: 'Cinco herramientas de IA gratis, y la número tres parece magia'.",
        "AUTORIDAD: posiciona el contenido como lo que los que saben ya usan. Ej. de molde: 'Esto es lo que de verdad usan los que trabajan con IA todos los días'.",
        "RETO AL ESPECTADOR: lanza un desafío práctico. Ej. de molde: 'Apuesto a que no sabías que podías hacer esto en menos de un minuto'.",
    ],
    "Umbral Alterno": [
        ...
        "RESULTADO PRIMERO (open loop): empieza por el final del mundo alterno y promete mostrar el camino. Ej. de molde: 'En este mundo, la humanidad tomó otra decisión. Así terminó todo'.",
        "POV INMERSIVO: mete al espectador dentro del escenario. Ej. de molde: 'Despiertas en un mundo donde esa guerra nunca terminó'.",
        "CONTRARIAN HISTÓRICO: desafía lo que se da por sentado de la historia. Ej. de molde: 'Todo lo que crees que era inevitable, pudo no haber pasado'.",
        "CUENTA REGRESIVA AL CAMBIO: marca el momento justo antes de que todo se bifurque. Ej. de molde: 'Faltaban segundos para la decisión que partiría la historia en dos'.",
        "DILEMA DEL DESTINO: plantea la elección que lo cambió todo. Ej. de molde: 'Una sola decisión separaba este mundo del nuestro'.",
    ],
}
