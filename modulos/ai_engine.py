...
class AIEngine:
    def __init__(self):
        ...
        7. ILUMINACIÓN CINEMATOGRÁFICA OBLIGATORIA: claroscuro EXTREMO. Un haz de luz lateral FUERTE entrando por ventana o puerta entreabierta, contrastando con sombras profundas casi negras alrededor. Estilo de iluminación tipo películas Insidious, Sinister, The Conjuring. Rayos de luz volumétricos visibles cortando la oscuridad con polvo y neblina suspendidos. La mayor parte de la imagen debe estar en sombra profunda, solo la zona iluminada por el haz tiene detalle visible. Color de luz: ámbar cálido o luz lunar azulada fría. NUNCA luz plana ni difusa.
